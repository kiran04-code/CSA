...
import { Code, Bot, ShieldCheck, Zap, Layers, Server, ArrowRight } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto h-full flex flex-col justify-center px-6 sm:px-8">
        ...
        <div className="relative z-10 mb-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white text-left leading-tight">
            Our{" "}
        ...
        <div
          ref={trackRef}
          // ✅ CHANGED: Smaller gap on mobile (gap-8), larger on other screens (sm:gap-24).
          ...
          {domainData.map((domain, index) => (
            <div
              ...
              ref={(el) => { if (el) itemRefs.current[index] = el; }}
               // ✅ CHANGED: Reduced card width on mobile (w-[70vw]) for a shorter scroll distance.
              className={`relative flex-shrink-0 w-[70vw] sm:w-[60vw] md:w-[40vw] lg:w-[30vw] flex flex-col items-center justify-center text-center`}
            >
