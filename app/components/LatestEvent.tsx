...
const FeaturedEventImage: React.FC<FeaturedEventProps> = ({
  ...
  return (
    <section className="bg-black  sm:py-5 inset-0 bg-gradient-to-t from-black via-black/70 to-transparent  px-4 sm:px-8 md:px-16 flex gap-20 flex-col justify-center items-center">
